...
public class AuthController {
    ...
    public ResponseEntity<TokenDto> authorize(@Valid @RequestBody LoginDto loginDto){
        ...
        httpHeaders.add(JwtFilter.AUTHORIZATION_HEADER, "Bearer " + jwt); // jwt를 Response Header에도 넣고

        return new ResponseEntity<>(new TokenDto(jwt), httpHeaders, HttpStatus.OK); // Response Body에도 넣음
    }
}
